...
public class ProductoDB_OLD {

    private List<Producto> catalogo;

    public ProductoDB_OLD() {
        ...
        Producto p5 = new Producto(60);
        p5.setCategoria("Telefonia movil");
        p5.setNombre("LG G4");
        p5.setPrecio(180);
        
        Producto p6 = new Producto(8);
        p6.setCategoria("Telefonia movil");
        p6.setNombre("Opo");
        p6.setPrecio(180);
